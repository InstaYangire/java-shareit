...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto update(Long itemId, Long ownerId, ItemDto itemDto) {
        ...
        if (itemDto.getDescription() != null && !itemDto.getDescription().isBlank()) existing.setDescription(itemDto.getDescription());
    ...
    public CommentDto addComment(Long userId, Long itemId, CommentDto commentDto) {
        ...
        bookingRepository.findFirstByItem_IdAndBooker_IdAndStatusAndEndBefore(
                        itemId, userId, BookingStatus.APPROVED, LocalDateTime.now())
                .orElseThrow(() -> new ValidationException("User has not completed booking of this item"));
